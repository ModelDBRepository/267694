...
#to be activated on at the time to stimulate the segments belonging to each region!!!!!

#stim_xy = ([-400, -290, -1030, -975, 1], #102 syn 90 * 80
    #[-360, -320, -997, -970, 2], #24syn
    #[-400, -285, -1150, -1050, 0])
#branchPF = "first_branch" 
    
stim_xy = ([-400, -290, -960, -920, 1], 
        [-330, -310, -960, -920, 2], #
        [-400, -285, -1150, -1050, 0])
branchPF = "second_branch"     
    
#stim_xy = ([-380, -300, -905, -870, 1],
    #[-360, -320, -900, -875, 2],
    #[-375, -315, -900, -870, 0]) #101 syn
